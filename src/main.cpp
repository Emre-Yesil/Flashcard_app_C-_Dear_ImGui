...
constexpr auto WINDOW_WIDTH = std::uint32_t{1440};
...
int main(int, char **)
{
    ...
    static auto *window = glfwCreateWindow(static_cast<std::int32_t>(WINDOW_WIDTH),
    ...
    */
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        int display_w, display_h; // maybe it is need extra optimization
        glfwGetFramebufferSize(window, &display_w, &display_h);
